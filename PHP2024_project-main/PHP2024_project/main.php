            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0">
                ...
                <form method="POST" id="" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    <div id="tamanho">
                        ...
                        <div class="grade">
                            <div class="content">                           
                                    <input class="form-check-input" type="radio" name="tamanho" id="pequeno" value="pequenho">
                    ...
                    <div id="queijo">
                        ...
                        <div class="grade">
                            ...
                            <div class="content">
                                <input class="form-check-input" type="radio" name="queijo" id="" value="null">
                ...
                <?php
                    ...
                    if($booltamanho && $boolpao && $boolrecheio && $boolproteina && $boolqueijo === true){
                        ...
                        echo "<br><br> <div style='display: flex; margin: auto;'> <h5 id='falta' style='margin-left: auto; margin-right: auto;'> Parece que seu pedido esta incompleto, ainda falta escolher";
